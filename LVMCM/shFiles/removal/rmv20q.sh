...
echo "Running removal experiment (N=20 with environmental response function)"

PARFILE=/data/home/btx188/LVMCM_src/LVMCM/parFiles/removal/bFileRemovalq20.txt
