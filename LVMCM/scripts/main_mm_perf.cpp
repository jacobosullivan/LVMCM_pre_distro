...
/* This script runs a simple performance test of the parallel numerical approximation of the LVMCM
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        meta = Metacommunity(
                ...
                a_jobID);
        meta.printParams();
//        meta.sppPool.topo.network.load("/data/home/btx188/LVMCM_src/LVMCM/perfTemplate/X.mat");
        meta.sppPool.topo.network.load("/data/home/aax010/git/LVMCM_src/LVMCM/perfTemplate/X.mat");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        { // invader testing scope
            meta.performanceTest(true, a_perfRep, a_perfS, floor(a_perfS) / 2);
            time(&time1);
            meta.metaCDynamics(meta.tMax, -1);
            time(&time2);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            { // subdomain initialization scope
                int S_p, S_c;
                if (rank == 0) {
//                metaSub.sppPool.topo.network.load("/data/home/btx188/LVMCM_src/LVMCM/perfTemplate/X.mat");
                    metaSub.sppPool.topo.network.load("/data/home/aax010/git/LVMCM_src/LVMCM/perfTemplate/X.mat");
                    cout << "\nNetwork rows 0-4 = " << endl;
